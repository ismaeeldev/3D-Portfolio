      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:m.ismaeel.developer@gmail.com" target="_blank" className="blue-text-gradient">
              m.ismaeel.developer@gmail.com
            </a>

          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=3176096871&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +92 3176096871
            </a>
          </article>
        </div>
